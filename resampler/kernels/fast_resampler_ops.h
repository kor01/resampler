...
#ifndef _RESAMPLER_KERNELS_RESAMPLER_OPS_H_
#define _RESAMPLER_KERNELS_RESAMPLER_OPS_H_
...
template <typename Device, typename T>
struct FastResamplerGrad2DFunctor {
  void operator()(::tensorflow::OpKernelContext* ctx, const Device& d,
                  const T* __restrict__ data, const T* __restrict__ warp,
...
#endif  // _RESAMPLER_KERNELS_RESAMPLER_OPS_H_
